...
import plotly.express as px # Aunque se usará seaborn para la matriz de correlación para guardar fácilmente.
...
import os       # Importa la biblioteca os para manejar rutas de archivos y directorios

# --- Configuración para guardar gráficos ---
output_folder = 'Datos'
...
plt.savefig(os.path.join(output_folder, 'churn_distribution.png'), dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('Número de Clientes', fontsize=12)
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig(os.path.join(output_folder, 'tenure_churn_distribution.png'), dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('Número de Clientes', fontsize=12)
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig(os.path.join(output_folder, 'monthly_charges_churn_distribution.png'), dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('Número de Clientes', fontsize=12)
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.savefig(os.path.join(output_folder, 'total_charges_churn_distribution.png'), dpi=300, bbox_inches='tight')
plt.show()
...
if 'Cuentas_Diarias' in df.columns:
    ...
    plt.ylabel('Número de Clientes', fontsize=12)
    plt.grid(axis='y', linestyle='--', alpha=0.7)
    plt.savefig(os.path.join(output_folder, 'daily_charges_churn_distribution.png'), dpi=300, bbox_inches='tight')
    plt.show()
...
def plot_churn_rate_by_category(dataframe, column, figsize=(8, 5)):
    ...
    plt.savefig(os.path.join(output_folder, f'churn_rate_by_{column.replace("_", "")}.png'), dpi=300, bbox_inches='tight')
    plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(output_folder, 'correlation_matrix.png'), dpi=300, bbox_inches='tight')
plt.show()